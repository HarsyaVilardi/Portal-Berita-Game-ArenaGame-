    ...
    <footer class="bg-dark border-t border-gray-800 mt-20">
        <div class="container mx-auto px-4 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    <div class="flex items-center space-x-2 mb-4">
                        ...
                        <span class="text-xl font-bold">CriticalFrame</span>
                    </div>
                    <p class="text-gray-400 text-sm">Portal berita dan komunitas esports terdepan di Indonesia.</p>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-gray-400">
                        <li><a href="#" class="hover:text-primary transition-colors">Esports</a></li>
                        <li><a href="#" class="hover:text-primary transition-colors">Games</a></li>
                        <li><a href="#" class="hover:text-primary transition-colors">Tech</a></li>
            ...
            <div class="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
                <p>&copy; 2025 CriticalFrame.com. All rights reserved.</p>
            </div>
        </div>
    </footer>
